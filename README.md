...
Version 0.1.9 provides the executable Fusion add-in skeleton, the first
...
can create and dimensionally verify the first extruded single-gear body with a round bore in a
