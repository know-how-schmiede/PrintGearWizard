...
Version 0.1.3 provides the executable Fusion add-in skeleton, the first
Fusion-independent gear-train calculation core, and the standard three-tab
configuration dialog with live input validation. The add-in registers a
